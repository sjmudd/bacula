...
/*
 * At the end of the job, the accurate code loops over all files
 * that are in the accurate list but not marked as seen during the
 * backup.  Unless the checkFile routine returns bRC_Seen,
 * these files look to be deleted and hence will not be
